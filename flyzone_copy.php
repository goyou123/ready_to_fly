...
<html lang="en">
    <head>
        ...
        <!-- 무한스크롤 -->
        <script>
            var idx = $("#tab-1 .img_area").last().index();
            // var p12 = "Ssss";
            var isEND = false;
            $(function(){
...
///////////////////////////////
        //         var p1 = "Sss";
        // // let startNo = $("#tab-1 .img_area").last().data("no") || 0;
        // // console.log("startNO :" +startNo);
        // var idx = $("#tab-1 .img_area").last().index(); //=3 마지막 글
        // console.log("idx :" +idx);
        // var start =0;
        // var list = 3;
        // $.ajax({
...
////////////////////////////////
    ...
    // }
        ...
        ////////////////////////////////////////////////////////////////////////////
            let html = "<p>무한스크롤 예제</p>";
            // $("#tab-1").append("infi_scroll_ok.php");
        ...
        <!-- <script> var idx1 = $("#tab-1 .img_area").last().index();
    console.log("idx1 넘길꺼 "+idx1)</script> -->
        <?php 
            // $js_idx = "<script>document.write(idx12);</script>";
            // var_dump($js_idx);    
            ?>
        ...
        <section class="visual3_recommend_flyzone">
            ...
            <div class="zone_all">
                ...
                <div class="zone_li current" id="tab-1">
                    ...
                    <?php } ?> <!--while문 종료-->
                    <!-- 무한스크롤 리스트 출력  -->
                    <div id="result" class="img_area1"></div>
                </div> <!--tab-1닫기-->
