                ...
                <div class="table">
                    <table class="main_table">
                        ...
                        <tbody>
                            ...
                            $query ="SELECT * FROM main_board order by idx desc limit $start_num,$list"; 
                            $result = mysqli_query($conn,$query);                            
                            while($total = mysqli_fetch_array($result)){
                                $title = $total["title"];
                                //만약 제목이 20글자 넘어가면 ...으로 바꾸기
                                // if(strlen($title)>12){
                                //     $title=str_replace($total["title"],mb_substr($total["title"],0,12,"utf-8")."...",$total["title"]);
                                // }
                                //댓글 개수 확인
                                $idx = $total["idx"];
                            ...
                            <tr>
                                ...
                                <td><a href="read.php?idx=<?php echo $total["idx"];?>"><?php echo $title ?> &nbsp;[<?php echo $count_result[0];?>]</a></td>
